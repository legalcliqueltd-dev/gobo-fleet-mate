...
-- USAGE
-- =============================================
-- Tokens are stored per user with RLS
-- Devices track when their status changed and when they were last notified
-- Edge function notify-inactivity uses these timestamps to avoid duplicate alerts
